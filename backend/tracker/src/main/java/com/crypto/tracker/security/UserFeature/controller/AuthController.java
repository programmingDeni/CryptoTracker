package com.crypto.tracker.security.UserFeature.controller;

import com.crypto.tracker.security.dtos.Auth.*;
import com.crypto.tracker.security.UserFeature.Services.AuthService;
import com.crypto.tracker.security.UserFeature.Services.UserService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> getCurrentUser() {
        try {
            ...
            // 3. User aus DB holen
            UserModel user = userService.findByEmail(userPrincipal.getEmail());
