 ...
 * Stellt Helper-Methoden bereit um auf den aktuell authentifizierten User
 * zuzugreifen.
 */
public class SecurityUtils {
     ...
     * @throws RuntimeException wenn User nicht authentifiziert ist oder Principal
     *                          kein UserPrincipal ist
     */
